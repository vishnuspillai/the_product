    ...
    switch (type) {
      case 'photography':
        return {
          ...
          gallery: [
            "https://drive.google.com/file/d/1T7AauFwWR-kFuKrrMrwTg13hSxdpGWHU/view?usp=drive_link?auto=compress&cs=tinysrgb&w=400",
      ...
      case 'stocks':
        return {
          ...
          strategies: ["RSI+Moving Averages", "Momentum Trading", "Pairs Trading", "Volume Charts"],
          performance: {
