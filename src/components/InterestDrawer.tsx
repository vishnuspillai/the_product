    ...
    switch (type) {
      case 'photography':
        return {
          ...
          description: "Photography is my creative outlet where I explore the world through different perspectives. From landscapes to portraits, I find joy in freezing moments in time. I am experienced with <b> Nikon </b> and my personal phone, the Nothing Phone 3a",
          highlights: [
            {
